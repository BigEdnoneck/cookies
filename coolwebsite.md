...
if (!bestScore || average < bestScore) {bestScore = average;localStorage.setItem('bestScoreAim', bestScore);bestScoreEl.textContent = ${bestScore} ms;
}resultsEl.classList.remove('hidden');
}function resetGame() {currentRound = 0;activeDotsPopped = 0;
roundTimes = [];currentRoundEl.textContent = "0";
